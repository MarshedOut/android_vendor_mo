...
ALARM_PATH := vendor/mo/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/mo/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/mo/prebuilt/common/media/audio/ringtones
UI_PATH := vendor/mo/prebuilt/common/media/audio/ui
